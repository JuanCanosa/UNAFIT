...
export async function enviarEmailBoasVindasAcademia(params: {
  ...
  const { email, nomeAcademia, senhaTemporaria, linkLogin } = params;
  ...
  const corpo = `
    <p style="margin:0 0 16px;font-size:15px;color:#a1a1aa;line-height:1.6;">
      ...
      <strong style="color:#ffffff;">UNAFIT</strong>. Para ativar o sistema, complete seu cadastro acessando o link abaixo.
    </p>
    ...
    <div style="background:#27272a;border-radius:8px;padding:16px 20px;margin:0 0 24px;">
      ...
      <p style="margin:0 0 4px;font-size:14px;color:#a1a1aa;">E-mail: <strong style="color:#ffffff;">${email}</strong></p>
      <p style="margin:0;font-size:14px;color:#a1a1aa;">Senha temporária: <strong style="color:#ffffff;font-family:monospace;font-size:16px;letter-spacing:.05em;">${senhaTemporaria}</strong></p>
    </div>
    ...
    <p style="margin:0;font-size:12px;color:#52525b;">
      Após completar o cadastro, você poderá acessar o painel da academia e cadastrar alunos, colaboradores e gerenciar tudo pelo sistema.
    </p>
  `;
